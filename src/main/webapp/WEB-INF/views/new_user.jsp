		...
		<div class="row">
			...
			<form:form action="save" method="post" modelAttribute="user">
				...
				<div class="form-group">
					...
					<form:input path="userName" class="form-control" required="true" minlength="3" maxlength="13"
					/>
				...
				<div class="form-group">
					...
					<form:password path="password" class="form-control" required="true" minlength="3" maxlength="13"
					/>
